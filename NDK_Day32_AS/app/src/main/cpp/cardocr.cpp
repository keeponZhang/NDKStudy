...
int co1::find_card_numbers(const Mat &mat, std::vector<Mat> numbers) {
    ...
    imwrite("/storage/emulated/0/card_number_binary_n.jpg", binary);
    ...
    imwrite("/storage/emulated/0/card_number_binary_not_n.jpg", binary_not);
    vector<vector<Point> > contours;
    ...
    imwrite("/storage/emulated/0/card_number_binary_noise_n.jpg", binary);
